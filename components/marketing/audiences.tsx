...
const AUDIENCES = [
  {
    ...
    body: "From rural villages to city centers, every Bangladeshi gets a single health record, AI triage at midnight, and a trusted doctor a tap away. No more lost lab reports. No more guessing.",
  ...
  },
  {
    ...
    body: "An anonymised, district-level view of consultations, prescriptions, outbreaks and outcomes — built to support ministries, health agencies, and policy makers shaping Bangladesh's healthcare future.",
    ...
    imageAlt: "Regional health intelligence dashboard showing district-level analytics across Bangladesh",
